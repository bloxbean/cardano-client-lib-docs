---
description: A client library for Cardano in Java
---
...
**Preview Version** (Alonzo changes & Raspberry pi Support) : [0.2.0-beta1](https://github.com/bloxbean/cardano-client-lib/releases/tag/v0.2.0-beta1)
...
The plugin also provides integration with Cardano node through different backend services. Out of box, the library currently supports integration with [Blockfrost](https://blockfrost.io) through the Backend api.
